...
public class ScientificActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int[] names = { R.id.buttonSin, R.id.buttonCos, R.id.buttonTan,
				R.id.button1x, R.id.buttonFac, R.id.buttonSqrt, R.id.buttonLn,
				R.id.buttonLog, R.id.buttonPers, R.id.buttonPi, R.id.buttonPow,
