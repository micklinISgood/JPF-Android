...
public class CalculatorActivity extends Activity implements OnClickListener {
	...
	protected void restoreState() {
		...
		if (extra != null) {
			// restore state
			valueEdit.setText(extra.getString("valueEdit"));
			calc.setText(extra.getString("calcValue"));
			equals = extra.getBoolean("equals");
			valueEdit.setSelection(extra.getInt("start"));
		} else
			valueEdit.setText("");
	}
