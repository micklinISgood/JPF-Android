...
public class TimelineAdapter extends SimpleCursorAdapter {
	...
	static final String[] FROM = { DatabaseInterface.C_TITLE,
			DatabaseInterface.C_PUB_DATE };// , "feed_title" };
	static final int[] TO = { R.id.textTitle, R.id.textPubDate };// ,
																	// R.id.textFeedTitle
																	// };
	...
	public void bindView(View row, Context context, Cursor cursor) {
		...
		long timestamp = cursor.getLong(cursor
				.getColumnIndex(DatabaseInterface.C_PUB_DATE));
...
//		String feed = cursor.getString(cursor.getColumnIndex("feed_title"));
//		TextView textFeedTitle = (TextView) row
//				.findViewById(R.id.textFeedTitle);
