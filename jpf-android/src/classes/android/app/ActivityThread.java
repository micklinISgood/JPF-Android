...
public final class ActivityThread {
	...
	class ApplicationThread {
		...
		public final void scheduleRelaunchActivity(String activityName,
				Intent intent) {
		...
		private void performLaunchActivity(String activityname,
				Intent startingIntent, int requestCode) {
		...
		private void performFinishActivity(int resultCode, Intent resultData) {
			...
			if (currentActivity.parent.mStartedActivity) {
				ResultInfo res = new ResultInfo(
						current.activity.getPackageName(), current.requestCode,
						current.activity.mResultCode,
						current.activity.mResultData);
...
//        CompatibilityInfo compatInfo;
	...
	private void deliverResults(ActivityClientRecord r, ResultInfo result) {
		r.activity.dispatchActivityResult(result.mResultWho,
				result.mRequestCode, result.mResultCode, result.mData);
	}
	...
	private void handleDestroyActivity(int token, boolean finishing,
	...
	private Activity performLaunchActivity(ActivityClientRecord r,
		...
		try {
			...
			if (activity != null) {
				...
				// activity.attach(this, null, ((currentActivity != null) ?
