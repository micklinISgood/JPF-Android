...
public class Dialog implements DialogInterface{ //, Window.Callback,        KeyEvent.Callback, OnCreateContextMenuListener {
    ...
    private Activity mOwnerActivity; // The activity this dialog is displayed over
    
    final Context mContext; //application context
    final WindowManager mWindowManager; //handle on Window manager service
    Window mWindow; //the new window for this dialog
    View mDecor; //content parent
   ...
   // private final Thread mUiThread; // is nessary if an dialog is created from a async thread 
