...
public class MessageQueue {
	...
	// TODO private int mPtr; // used by native code

	// private native void nativeInit();
	//
	// private native void nativeDestroy();
	//
	// private native void nativePollOnce(int timeoutMillis);
	//
	 ...
	 */
	// TODO public final void addIdleHandler(IdleHandler handler) {
	// if (handler == null) {
	 ...
	 */
	// TODO public final void removeIdleHandler(IdleHandler handler) {
	// synchronized (this) {
