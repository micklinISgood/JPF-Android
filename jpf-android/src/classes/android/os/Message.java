...
public final class Message implements Parcelable {
	...
	/* package */static final int FLAGS_TO_CLEAR_ON_COPY_FROM = FLAGS_RESERVED
			| FLAG_IN_USE;
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		// TODO Messenger.writeMessengerOrNullToParcel(replyTo, dest);
	}
	...
	private final void readFromParcel(Parcel source) {
		...
		// TODO replyTo = Messenger.readMessengerOrNullFromParcel(source);
	}
}
