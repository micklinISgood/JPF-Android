...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, ((WorkerRunnable<?, ?>)r).getClassName() +  "#" + mCount.getAndIncrement());
        }
    };
     ...
     */
    public AsyncTask() {
        mWorker = new WorkerRunnable<Params, Result>(this.getClass().getSimpleName()) {
    ...
    private Result postResult(Result result) {
        Message message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
               ((Object) new AsyncTaskResult<Result>(this, result)));
    ...
    private static abstract class WorkerRunnable<Params, Result> implements Callable<Result> {
        ...
        public WorkerRunnable(String className){
