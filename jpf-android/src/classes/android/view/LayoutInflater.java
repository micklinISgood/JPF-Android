...
public class LayoutInflater {
	...
	/**
	 * Recursively parses the layout file and inflates the {@link View} objects
	 * to form a {@link View} hierarchy.
	 * 
	 ...
	 */
	public View inflateView(String type) throws ClassNotFoundException,
		...
		Class<View> cls = (Class<View>) Class.forName(WIDGET_PACKAGE + "."
				+ type);
